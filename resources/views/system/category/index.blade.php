                ...
                <form method="post" action="{{ route('category.store') }}" autocomplete="off" class="form-horizontal">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('categoría') }}" value="{{ old('name') }}" aria-required="true"/>
                                    @if ($errors->has('name'))
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <a rel="tooltip" class="btn btn-flat btn-md btn-danger" href="{{ route('category.index') }}" data-toggle="tooltip" data-placement="top" title="Cancelar">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-info">
                        ...
                        <p class="card-category"> {{ __('En esta pantalla el sistema muestra todas las Categorías registradas.') }}</p>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('category.index') }}" autocomplete="off" class="form-horizontal">
                            @csrf
                            @method('get')
                                    ...
                                    @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form method="post" action="{{ route('category.delete', $item) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <a rel="tooltip" class="btn btn-warning btn-sm btn-round" href="{{ route('category.edit', $item) }}" data-toggle="tooltip" data-placement="top" title="Editar información">
                                                    ...
                                                    <a rel="tooltip" class="btn btn-info btn-sm btn-round" href="{{ route('category.show', $item) }}" data-toggle="tooltip" data-placement="top" title="Ver sub categorías">
