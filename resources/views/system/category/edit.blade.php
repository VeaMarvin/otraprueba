                ...
                <form method="post" action="{{ route('category.update', $category) }}" autocomplete="off" class="form-horizontal">
                    ...
                    <div class="card ">
                        <div class="card-header card-header-warning">
                            ...
                            <p class="card-category">{{ __('Modificar la categoría con nombre ') }} <strong>{{ $category->name }}</strong></p>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    name="name" id="input-name" type="text" placeholder="{{ __('categoría') }}" value="{{ old('name',$category->name) }}" aria-required="true"/>
                                    @if ($errors->has('name'))
