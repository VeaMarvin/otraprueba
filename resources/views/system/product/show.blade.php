    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Información del producto {{ $product->title }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card card-nav-tabs">
                    ...
                    <div class="card-body">
                      <blockquote class="blockquote mb-0">
                        ...
                        <footer class="blockquote-footer">Fecha de ingreso <cite title="Source Title">{{ $product->getFormatoFechaAttribute() }}</cite></footer>
                      </blockquote>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 ml-auto mr-auto">
                <div class="card card-pricing bg-info">
                    <div class="card-body ">
                        <div class="card-icon"><i class="material-icons">notification_important</i></div>
                        <h3 class="card-title">{{ number_format($product->discount,2,'.',',') }}%</h3>
                        <p class="card-description">
            ...
            <div class="col-md-4">
                <form method="post" action="{{ route('image.store', $product) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card ">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">{{ __('Nueva imagen') }}</h4>
                            <p class="card-category">{{ __("Agregar una nueva imagen al producto {$product->getNameCompleteAttribute()}") }}</p>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                    ...
                                    <div class="fileinput fileinput-new text-center">
                                        ...
                                        <div>
                                            <span class="btn btn-raised btn-round btn-rose btn-file">
                                                ...
                                                <input type="file"  onchange="return fileValidation()" name="photo" id="input-photo" />
                                            </span>
                                        </div>
                                    </div>
                                    @if ($errors->has('photo'))
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <a rel="tooltip" class="btn btn-flat btn-md btn-danger" href="{{ route('product.show', $product) }}" data-toggle="tooltip" data-placement="top" title="Cancelar">
            ...
            <div class="col-md-8">
                ...
                <form method="post" action="{{ route('image.delete', $item) }}">
                    @csrf
                    @method('delete')
                    <button rel="tooltip" data-toggle="tooltip" data-placement="top" title="Eliminar información" type="button" class="btn btn-danger btn-sm btn-round" onclick="confirm('{{ __("¿Está seguro que desea eliminar la imagen del producto {$product->title} ?") }}') ? this.parentElement.submit() : ''">
